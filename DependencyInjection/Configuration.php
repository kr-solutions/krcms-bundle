            ...
            ->arrayNode('model')
                ...
                ->addDefaultsIfNotSet()
                    ->children()
                        ...
                        ->scalarNode('header_class')->defaultValue('KRSolutions\\Bundle\\KRCMSBundle\\Entity\\Header')->cannotBeEmpty()->end()
                        ->scalarNode('language_class')->defaultValue('KRSolutions\\Bundle\\KRCMSBundle\\Entity\\Language')->cannotBeEmpty()->end()
                        ...
                        ->scalarNode('slider_class')->defaultValue('KRSolutions\\Bundle\\KRCMSBundle\\Entity\\Slider')->cannotBeEmpty()->end()
                        ->scalarNode('slider_image_class')->defaultValue('KRSolutions\\Bundle\\KRCMSBundle\\Entity\\SliderImage')->cannotBeEmpty()->end()

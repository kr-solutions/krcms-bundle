...
use KRSolutions\Bundle\KRCMSBundle\Form\Type\KRCMSSliderImageType;
...
class HeaderController extends AbstractKRCMSController
{
    ...
    public function sliderImagesAction(Request $request, $sliderId)
    {
        ...
        $newSliderImage = new SliderImage();
        $sliderImageForm = $this->createForm(KRCMSSliderImageType::class, $newSliderImage);
